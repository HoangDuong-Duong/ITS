...
import com.elcom.its.notify.model.dto.NotifyDTO;
...
public interface NotifyService {
    ...
    ResponseMessage sendNotifyZalo(NotifyRequestDTO requestDTO);
    
    ResponseMessage notifyImportFile(NotifyRequestDTO requestDTO);
}
