 ...
 */
package com.elcom.its.notify.constant;
...
public class Constant {
    ...
    // Notify message
    public static final String NOTIFY_PATROL_VIOLATION = "patrol_violation";
    public static final String NOTIFY_MOBILE = "NOTIFY_MOBILE";
}
