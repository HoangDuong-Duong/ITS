...
public class RabbitMQProperties {
    ...
    @Value("${tollstation.rpc.queue}")
    public static String TOLLSTATION_RPC_QUEUE;

    @Value("${tollstation.rpc.exchange}")
    public static String TOLLSTATION_RPC_EXCHANGE;

    @Value("${tollstation.rpc.key}")
    public static String TOLLSTATION_RPC_KEY;
    ...
    public RabbitMQProperties(@Value("${user.rpc.exchange}") String userRpcExchange,
            ...
            @Value("${tollstation.rpc.queue}") String managementRpcQueue,
            @Value("${tollstation.rpc.exchange}") String managementRpcExchange,
            @Value("${tollstation.rpc.key}") String managementRpcKey,
        ...
        TOLLSTATION_RPC_QUEUE = managementRpcQueue;
        TOLLSTATION_RPC_EXCHANGE = managementRpcExchange;
        TOLLSTATION_RPC_KEY = managementRpcKey;
