...
import com.elcom.its.vds.service.SiteService;
...
public class SiteServiceImpl implements SiteService {
    ...
    @Override
    public SiteInfoNewResponseList getListSiteInListStage(String stageCodes) {
        String uri = URI + "/site-in-stage?stageCodes=" + stageCodes;
        return restTemplate.getForObject(uri, SiteInfoNewResponseList.class);
    }
}
