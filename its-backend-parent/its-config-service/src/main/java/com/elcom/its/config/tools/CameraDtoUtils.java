package com.elcom.its.config.tools;
...
import com.elcom.its.config.model.dto.PtzInfo;
...
public class CameraDtoUtils {
    ...
    public static CameraCreateUpdateDTO getCreateUpdateCameraDtoFromBodyParam(Map<String, Object> bodyParam) {
        ...
        String stationId = (String) bodyParam.get("stationId");
        Integer displayLevel = (Integer) bodyParam.get("displayLevel");
        ...
        cameraDTO.setStationId(stationId);
        cameraDTO.setDisplayLevel(displayLevel);
