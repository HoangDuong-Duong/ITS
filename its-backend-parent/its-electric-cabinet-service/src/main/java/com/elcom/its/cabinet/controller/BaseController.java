...
import com.elcom.its.cabinet.messaging.rabbitmq.RabbitMQClient;
import com.elcom.its.cabinet.messaging.rabbitmq.RabbitMQProperties;
...
public class BaseController {
    ...
    public ABACResponseDTO checkMapPermission(AuthorizationResponseDTO user, String requestMethod, String requestPath, String stageId)
        ...
        if (stageId != null) {
            ...
            subject.put("stageId", stagesForUser);
        }
