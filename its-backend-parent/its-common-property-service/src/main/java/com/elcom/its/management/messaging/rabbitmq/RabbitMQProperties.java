...
public class RabbitMQProperties {
    ...
    public RabbitMQProperties(@Value("${user.rpc.exchange}") String userRpcExchange,
            ...
            @Value("${property.rpc.queue}") String managementRpcQueue,
            @Value("${property.rpc.exchange}") String managementRpcExchange,
            @Value("${property.rpc.key}") String managementRpcKey,
