...
import com.elcom.abac.model.Unit;
...
public class AuthorizationResponseDTO {
    ...
    public AuthorizationResponseDTO(Map<String, Object> map){
        if(map != null && map.size() > 0){
            ...
            if(map.containsKey("policeRank")) this.policeRank = (String) map.get("policeRank");
            if(map.containsKey("position")) this.position = (String) map.get("position");
        }
    }
