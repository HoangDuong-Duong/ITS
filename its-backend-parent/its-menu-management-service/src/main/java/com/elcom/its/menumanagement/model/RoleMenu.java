...
public class RoleMenu implements Serializable {
    ...
    @Column(name = "can_detail")
    private Integer canDetail;
    ...
    public Integer getCanDetail() {
        return canDetail;
    }

    public void setCanDetail(Integer canDetail) {
    ...
    public String toString() {
        return "com.elcom.its.rbac.model.RoleMenu[ id=" + id + " ]";
    }
