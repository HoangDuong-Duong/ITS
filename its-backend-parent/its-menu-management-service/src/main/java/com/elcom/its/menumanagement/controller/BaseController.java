 ...
 */
package com.elcom.its.menumanagement.controller;

import com.elcom.its.constant.ResourcePath;
import com.elcom.its.menumanagement.dto.ABACResponseDTO;
import com.elcom.its.message.MessageContent;
import com.elcom.its.message.RequestMessage;
import com.elcom.its.message.ResponseMessage;
import com.elcom.its.menumanagement.messaging.rabbitmq.RabbitMQClient;
import com.elcom.its.menumanagement.messaging.rabbitmq.RabbitMQProperties;
import com.elcom.its.menumanagement.dto.AuthorizationResponseDTO;
import com.elcom.its.menumanagement.model.Resources;

import com.elcom.its.utils.StringUtil;
import com.elcom.its.utils.UrlPatternUtil;
import com.elcom.its.menumanagement.dto.GetRoleResponse;
...
public class BaseController {
    ...
    public ABACResponseDTO authorizeABAC(Map<String, Object> bodyParam, String requestMethod, String userUuid, String apiPath) throws ExecutionException, InterruptedException {
        ...
        LOGGER.info("RÉULT" + result.toString());
        if (result != null) {
            ObjectMapper mapper = new ObjectMapper();
            DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            mapper.setDateFormat(df);
