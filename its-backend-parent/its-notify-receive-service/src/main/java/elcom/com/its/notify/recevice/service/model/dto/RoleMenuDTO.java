...
public class RoleMenuDTO implements Serializable {
    ...
    public RoleMenuDTO(String roleCode, Map<String, Object> map){
        if(map != null && map.size() > 0){
            if(map.containsKey("menuId")) this.menuId = new MenuDTO((Integer) map.get("menuId"));
            if(map.containsKey("menuName")) this.menuName = (String) map.get("menuName");
            if(map.containsKey("orderNo")) this.orderNo = (Integer) map.get("orderNo");
    ...
    public String toString() {
        return "com.elcom.its.notify.model.dto.RoleMenuDTO[ id=" + id + " ]";
    }
