...
import com.elcom.its.id.controller.UnitController;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.elcom.its.id.controller.AuthenController;
import com.elcom.its.id.controller.UserController;
import com.elcom.its.id.exception.ValidationException;
            ...
            if (request != null) {
                ...
                switch (request.getRequestMethod()) {
                    case "GET":
                        ...
                        {
                            response = userController.getAllUser(headerParam, requestPath, request.getRequestMethod(), urlParam, bodyParam);
                        }
                    ...
                    case "POST":
                        ...
                        } else if ("/user/forgotPassword/checkOtp".equalsIgnoreCase(requestPath)) // Check OTP password
                        {
                            response = userController.checkOtpPassword(bodyParam, headerParam);
                    ...
                    case "PUT":
                        ...
                        } else if ("/user/forgotPassword/app".equalsIgnoreCase(requestPath))//Change password from forgot password for app
                        {
                            response = userController.updateForgotPasswordForApp(bodyParam, headerParam);
                        }
