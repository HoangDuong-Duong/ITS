...
import com.elcom.its.id.model.dto.TokenCache;
import com.elcom.its.id.repository.RedisRepository;
...
public class TokenServiceImpl implements TokenService {
    ...
    public String getAccessToken() {
        ...
        ITSCoreLoginResponse respsonse = restTemplate.postForObject(ApplicationConfig.ITS_AUTHEN_URL,
